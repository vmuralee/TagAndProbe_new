...
HLTLIST = cms.VPSet(
 ...
 cms.PSet (
    ...
    cms.PSet (
        HLT = cms.string("HLT_IsoMu19_eta2p1_LooseCombinedIsoPFTau20_v1"),
    ...
    cms.PSet (
        HLT = cms.string("HLT_IsoMu19_eta2p1_MediumCombinedIsoPFTau32_Trk1_eta2p1_Reg_v1"),
    ...
    cms.PSet (
        HLT = cms.string("HLT_IsoMu19_eta2p1_TightCombinedIsoPFTau32_Trk1_eta2p1_Reg_v1"),
   ...
   cms.PSet (
    ...
    cms.PSet (
        HLT = cms.string("HLT_IsoMu21_eta2p1_MediumCombinedIsoPFTau32_Trk1_eta2p1_Reg_v1"),
    ...
    cms.PSet (
        HLT = cms.string("HLT_IsoMu21_eta2p1_TightCombinedIsoPFTau32_Trk1_eta2p1_Reg_v1"),
