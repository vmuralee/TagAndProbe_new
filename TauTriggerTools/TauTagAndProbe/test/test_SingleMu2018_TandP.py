...
if not isMC:
    ...
    process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(            
                '/store/relval/CMSSW_10_6_0_pre2/RelValZpTT_1500_13UP17/MINIAODSIM/105X_mc2017_realistic_v7_ulhlt17_noPU-v1/10000/D3E7F80D-DC73-BE47-A46D-F4967765840F.root'
        )
    )
